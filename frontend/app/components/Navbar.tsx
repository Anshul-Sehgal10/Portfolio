      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => handleNavigate('experience')} className={`font-medium transition-all duration-300 hover:scale-110 ${darkMode ? 'text-white/90 hover:text-white' : 'text-black/90 hover:text-black'}`}>Experience</button>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4">
            <div className={`rounded-2xl border p-3 shadow-2xl backdrop-blur-lg ${darkMode ? 'bg-black/80 border-[#838ce5]/30 shadow-[#50207A]/20' : 'bg-white/85 border-[#838ce5]/35 shadow-[#50207A]/10'}`}>
              ...
              <button onClick={() => handleNavigate('experience')} className={`text-left px-3 py-2.5 rounded-xl transition-all duration-300 hover:translate-x-1 ${darkMode ? 'text-white/90 hover:text-white hover:bg-[#50207A]/40' : 'text-black/90 hover:text-black hover:bg-[#d6b9fc]/35'}`}>Experience</button>
